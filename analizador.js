...
function peg$parse(input, options) {
  ...
  var peg$e6 = peg$literalExpectation("function", false);
  ...
  var peg$f6 = function(typ, id, exp) { return crearNodo('declaracionVariable1', { type: typ, id, exp }) };
  var peg$f7 = function(id, exp) { return crearNodo('declaracionVariable', { id, exp }) };
  var peg$f8 = function(id, params, bloque) { return crearNodo('dclFunc', { id, params: params || [], bloque }) };
  var peg$f9 = function(id, dcls) { return crearNodo('dclClase', { id, dcls }) };
...
return op
  ...
  var peg$f42 = function() {return crearNodo('numero', { valor: parseFloat(text(), 10) })};
  var peg$f43 = function(exp) { return crearNodo('agrupacion', { exp }) };
  var peg$f44 = function(id, args) { return crearNodo('instancia', { id, args: args || [] }) };
  var peg$f45 = function(text) { return crearNodo('string', { valor: text })};
  var peg$f46 = function(text) { return crearNodo('null', { valor: text })};
  var peg$f47 = function(text) { return crearNodo('boolean', { valor: text })};
  var peg$f48 = function(text) { return crearNodo('char', { valor: text })};
  ...
  var peg$f52 = function() { return false; };
